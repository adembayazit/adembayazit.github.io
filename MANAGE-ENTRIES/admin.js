...
<body>
        ...
        <div class="editor-container">
            ...
            <div class="form-group">
                ...
                <div class="editor-toolbar">
                    ...
                    <button onclick="formatText('trContent', 'boldItalic')" title="Kalın İtalik"><i class="fas fa-bold"></i><i class="fas fa-italic"></i></button>
                    ...
                    <button onclick="addNewLine('trContent')" title="Yeni Satır"><i class="fas fa-level-down-alt"></i></button>
            ...
            <div class="form-group">
                ...
                <div class="editor-toolbar">
                    ...
                    <button onclick="formatText('enContent', 'boldItalic')" title="Bold Italic"><i class="fas fa-bold"></i><i class="fas fa-italic"></i></button>
                    ...
                    <button onclick="addNewLine('enContent')" title="New Line"><i class="fas fa-level-down-alt"></i></button>
    ...
    <script>
        ...
        function formatForDisplay(text) {
            ...
            // Kalın ve italik metin: ***kalın italik***
            ...
            // Paragraf: <p>paragraf</p>
            formatted = formatted.replace(/<p>(.*?)<\/p>/g, '<p>$1</p>');
        ...
        function addNewLine(textareaId) {
            ...
            textarea.value = textarea.value.substring(0, start) + '<p></p>' + textarea.value.substring(start);
            textarea.focus();
            
            // İmleci <p> etiketleri arasına yerleştir
